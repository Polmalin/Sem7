...
#     **Вывод:** Парам пам-пам
# def check_vowel(x):
#     return x in all_vowels
# def check_rhyme (countVowels,countVowelsPrevious ):
#     return countVowelsPrevious  == -1 or countVowels == countVowelsPrevious
# phrase = input("Введите фразу: ")
# countVowels=0
# all_vowels = ["а", "е", "ё", "и", "о", "у", "ы", "э", "ю", "я"]
# countVowelsPrevious=-1
# is_rhyme = True
# for x in phrase:
#     if check_vowel(x):
#         countVowels = countVowels+1
#     elif x== " ":
#         is_rhyme=check_rhyme(countVowels, countVowelsPrevious)
#         if is_rhyme==False:
#             break
#         countVowelsPrevious=countVowels
#         countVowels=0
# is_rhyme=check_rhyme(countVowels, countVowelsPrevious)
# if is_rhyme == True:
#     print ("Парам пам-пам")
